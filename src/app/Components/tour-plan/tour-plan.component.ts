  ...
  tourDays = [
    {
      ...
      description: 'Qui Tempore Voluptate Qui Quia Commodi Rem Praesentium Alias Et Voluptates Officia Sed Molestiae Sint Et Voluptas Quia. Qui Itorum Repudiandae Dolorum Deborem.',
      amenities: [
